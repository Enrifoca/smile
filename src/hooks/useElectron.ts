...
export function useElectron() {
  ...
  const contextsOnChanged = useCallback((callback: (contexts: import('../context/types').ProjectContext[]) => void) => api.contexts.onChanged(callback), [])
